 ...
 */
public class ControlNodeSequential extends ControlNodeInterface {

    private String                      node_name;
    private StartPolicyType             start_policy;
    private ControlNodeType             node_kind;
    private int                         node_id;
    public  List<ControlUpdateForPLP>   update_for_plp;
    public  String                      next_node_name;
    private List<String>                predecessors_names;
    private int                         concurrent_process_id;

    public ControlNodeSequential(){

        this.node_kind          = ControlNodeType.node_sequential;
        this.update_for_plp     = new LinkedList<>();
        this.next_node_name     = "";
